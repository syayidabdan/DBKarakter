...
<body>
    ...
    <div class="navbar bg-base-100 bg-neutral text-neutral-content">
        <div class="flex-1">
          <a class="btn btn-ghost text-xl">ADD CHARACTER</a>
        </div>
        <div class="flex-none">
    ...
    <h2 class="text-2xl text-sky-900 font-bold mb-6">Add Your Character</h2>
        <form method="post" action="/store">
        @csrf
          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-600">
              Name</label>
            <input class="mt-1 p-2 w-full border rounded-md" type="text" name="nama" />
          </div>
          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-600">
              Skill</label>
            <input
              class="mt-1 p-2 w-full border rounded-md" name="skill" type="text"/>
          </div>
          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-600">
              Jenis kelamin</label>
            <input type="text" class="mt-1 p-2 w-full border rounded-md" name="jeniskelamin"/>
          </div>
